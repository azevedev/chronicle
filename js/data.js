...
/**
 * Modern country for one of a figure's two pins, as [English, Portuguese], or
 * null when the pin is at sea. Generated by tools/derive-countries.mjs.
 */
export function countryFor(id, key) {
  return COUNTRIES[id]?.[key] ?? null;
}
